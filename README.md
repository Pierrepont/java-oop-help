...
- Implement suggestions.
  ...
  4. Change the uploaded program to reflect the changes. (Go to the file on GitHub and click the pencil, paste in your changed code, scroll down and press "Commit changes".)
